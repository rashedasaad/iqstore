...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('stripe/scss/index.css') }}">
...
<body>
    ...
    <form action="{{ route('buy') }}" method="POST" id="payment-form">
        ...
        <div class="allInput">
            ...
            <input class="email" name="email" type="email" placeholder="email requerd">
            <input class="number" name="number" type="number" placeholder="phone number not requerd">
        </div>
        ...
        <button type="submit" id="paymentok">Submit Payment</button>
    </form>
